...
# Typical invocation:
# spark-submit 2-just-vancouver.py tourism tourism-vancouver
# hdfs dfs -cat tourism-vancouver/* | gzip -d - | gzip -c > tourism-vancouver.json.gz
...
def main(inputs, output):
    poi = spark.read.json(inputs, schema=tourism_schema)
